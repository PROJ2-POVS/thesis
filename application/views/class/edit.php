<?php echo form_open('class/edit/'.$class['classID'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="subjectID" class="form-control">
				...
				{
					$selected = ($subject['sujectID'] == $class['subjectID']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="facultyID" class="form-control">
				...
				{
					$selected = ($faculty['facultyID'] == $class['facultyID']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="timeSlotID" class="form-control">
				...
				{
					$selected = ($timeslot['timeSlotID'] == $class['timeSlotID']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="venueID" class="form-control">
				...
				{
					$selected = ($venue['venueID'] == $class['venueID']) ? ' selected="selected"' : "";
