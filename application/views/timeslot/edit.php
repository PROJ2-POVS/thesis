<?php echo form_open('timeslot/edit/'.$timeslot['timeSlotID'],array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="dayOfWeek" class="col-md-4 control-label"><span class="text-danger">*</span>DayOfWeek</label>
		<div class="col-md-8">
			<input type="text" name="dayOfWeek" value="<?php echo ($this->input->post('dayOfWeek') ? $this->input->post('dayOfWeek') : $timeslot['dayOfWeek']); ?>" class="form-control" id="dayOfWeek" />
