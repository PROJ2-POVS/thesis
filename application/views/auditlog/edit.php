<?php echo form_open('auditlog/edit/'.$auditlog['auditID'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="userID" class="form-control">
				...
				{
					$selected = ($user['userID'] == $auditlog['userID']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="timestamp" value="<?php echo ($this->input->post('timestamp') ? $this->input->post('timestamp') : $auditlog['timestamp']); ?>" class="form-control" id="timestamp" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="auditDesc" class="form-control" id="auditDesc"><?php echo ($this->input->post('auditDesc') ? $this->input->post('auditDesc') : $auditlog['auditDesc']); ?></textarea>
