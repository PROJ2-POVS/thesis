<?php echo form_open('assignment/edit/'.$assignment['assignID'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="classID" class="form-control">
				...
				{
					$selected = ($class['classID'] == $assignment['classID']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="dateUploaded" value="<?php echo ($this->input->post('dateUploaded') ? $this->input->post('dateUploaded') : $assignment['dateUploaded']); ?>" class="form-control" id="dateUploaded" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="dateModified" value="<?php echo ($this->input->post('dateModified') ? $this->input->post('dateModified') : $assignment['dateModified']); ?>" class="form-control" id="dateModified" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="dateExpiry" value="<?php echo ($this->input->post('dateExpiry') ? $this->input->post('dateExpiry') : $assignment['dateExpiry']); ?>" class="form-control" id="dateExpiry" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="assignDesc" class="form-control" id="assignDesc"><?php echo ($this->input->post('assignDesc') ? $this->input->post('assignDesc') : $assignment['assignDesc']); ?></textarea>
